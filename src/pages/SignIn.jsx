  ...
  return (
    <div id='bg-login' className="h-screen bg-[#DFF2E8]">
      ...
      <div className='flex justify-center items-center h-full'>
        <div className='relative w-[33%] bg-white rounded-[15px] 2xl:px-20 lg:px-10 2xl:py-16 lg:py-11 shadow-king'>
            ...
            <form className='lg:mt-5 2xl:mt-10' action="">
                <input className='w-full h-[3.8vh] pl-4 border border-[#B4B4B4] border-1 rounded-[10px] outline-none text-[0.78125vw]' placeholder='Email' type="email" />
                <input className='2xl:mt-6 lg:mt-4 w-full h-[3.8vh] pl-4 border border-[#B4B4B4] border-1 rounded-[10px] outline-none text-[0.78125vw]' placeholder='Password' type="password" />
            </form>
