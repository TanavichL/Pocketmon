    ...
    <div className="min-h-screen bg-[#F9F8F8]">
        <div className='h-full w-full flex justify-center'>
            ...
            <div className='w-full h-screen flex justify-center items-center'>
                <div className="relative flex flex-col bg-white w-[50%] mt-44 mb-24 rounded-[20px] shadow-king">
                    ...
                    <div id='tree-bg' className='2xl:px-20 lg:px-8 py-12 flex flex-col items-center lg:space-y-3 2xl:space-y-6'>
