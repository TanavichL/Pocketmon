  ...
  return (
    <div className="min-h-screen bg-[#E6F2FD]">
      ...
      <div className="relative flex justify-center items-center h-full flex-col">
        <div className=" w-[60rem] h-[19rem] bg-white rounded-[15px] px-10 py-10 drop-shadow-xl mt-44">
          <div className="flex">
            ...
            <div className="flex-col">
              ...
              {!isEdit ? (
                <p id="name" className="font-jura text-[18px] ml-36">Name</p>
              ) : (
                <input
                    type="text"
                    id="name"
              ...
              {!isEdit ? (
                ...
                customer support specialists. We work closely together to create
                innovative solutions that simplify the process of managing your
                money.
              </p>):(
                <input
                    type="text"
        ...
        <div className="w-[60rem] h-auto bg-white rounded-[15px] mt-10 mb-20">
          <div className="border border-1 rounded-[15pm] w-[60rem] h-[5rem] flex items-center justify-between">
